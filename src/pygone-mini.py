...
class F0:
 ...
 def H9(Z,l,S,a,b):
  ...
  if not is_L1 and not E01 and L8 in l.K3:
   ...
   if d>=b:
    return b
  if not is_L1 and not E01 and e['M0']>=S and abs(e['M1'])<J and e['N1']:
