...
class F0:
 ...
 def G0(Z,l,N4,S):
  ...
  for F2 in l.A5():
   ...
   print(x)
   per_I9.append(x)
  print(f"Nodes H9ed: {sum(per_I9)}")
  print(f"Captures: {Z.G5} Checks: {Z.G6}")
 def H1(Z,l):
  H2=t()
  d=l.B6
  ...
  try:
   ...
   if Z3=="quit":
    ...
    if G01:
     ...
     H91.G6=0
     H91.G5=0
     H91.G0(I7,H91.S,H91.S)
     print("total time: ",t()-H2)
     continue
