...
class F0:
 ...
 def H9(Z,A3,S,L3,L4,H95=1):
  ...
  if T<=L2:
   Z.G3[A3.K3,S,H95]=Z8(T,K)
  elif T>=L4:
   Z.G3[A3.K3,S,H95]=Z8(T,L)
  else:
   Z.G3[A3.K3,S,H95]=Z8(T,H)
  return T
def main():
 I7=A6()
 H91=F0()
