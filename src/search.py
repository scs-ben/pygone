...
class Search:
    ...
    def search(self, depth, alpha, beta, ply):
        ...
        if entry and entry[0] == self.board.hash and entry[2] >= depth:
            # Flags: 0=Exact, 1=Lowerbound (Beta), 2=Upperbound (Alpha)
        ...
        for move in moves:
            ...
            if score > alpha:
                alpha = score
                if alpha >= beta:
                    # Store Beta Cutoff (Lowerbound, Flag 1)
        ...
        # Store TT: Exact (0) or Upperbound (2)
