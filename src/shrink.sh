...
sed -i -e 's/pawn_column_count/E34/g' pygone-mini.py
...
sed -i -e 's/interrupted_search/G73/g' pygone-mini.py
...
sed -i -e 's/king_offset/Q52/g' pygone-mini.py
...
sed -i -e 's/nullmove/S0/g' pygone-mini.py
sed -i -e 's/is_endgame/R1/g' pygone-mini.py
sed -i -e 's/piece_count/R2/g' pygone-mini.py
sed -i -e 's/king_row/R3/g' pygone-mini.py
sed -i -e 's/king_offset/R4/g' pygone-mini.py
sed -i -e 's/score_pawns/R5/g' pygone-mini.py
sed -i -e 's/piece_list/R6/g' pygone-mini.py
sed -i -e 's/is_reverse/R7/g' pygone-mini.py
sed -i -e 's/valid_pieces/R8/g' pygone-mini.py
sed -i -e 's/TABLE_LIMIT/R9/g' pygone-mini.py
sed -i -e 's/QS_LIMIT/R0/g' pygone-mini.py
sed -i -e 's/EVAL_ROUGHNESS/T1/g' pygone-mini.py
sed -i -e 's/Entry/T2/g' pygone-mini.py
sed -i -e 's/bounds/T3/g' pygone-mini.py
sed -i -e 's/counter/T4/g' pygone-mini.py
sed -i -e 's/picked_move/T5/g' pygone-mini.py
sed -i -e 's/last_pawn/T6/g' pygone-mini.py
sed -i -e 's/last_other/T7/g' pygone-mini.py
sed -i -e 's/is_hash/T8/g' pygone-mini.py
...
sed -i -e 's/bound/Z9/g' pygone-mini.py
